...
class LecturesControllerTest < ActionController::TestCase
  ...
  test "should create lecture" do
    assert_difference('Lecture.count') do
      post :create, lecture: { Course_id: @lecture.Course_id, attachement: @lecture.attachement, content: @lecture.content }
    end
  ...
  test "should update lecture" do
    patch :update, id: @lecture, lecture: { Course_id: @lecture.Course_id, attachement: @lecture.attachement, content: @lecture.content }
    assert_redirected_to lecture_path(assigns(:lecture))
  end
